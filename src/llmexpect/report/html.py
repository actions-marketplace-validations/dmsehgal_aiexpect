...
<title>llmexpect report</title><style>{_CSS}</style></head><body><div class="wrap">
<h1>llmexpect report</h1><p class="sub">{_e(payload["generated_at"])} · llmexpect {_e(payload["version"])} · Python {_e(payload["python"])}{(" · " + meta_line) if meta_line else ""}</p>
<div class="hero">
...
<p class="foot">Generated by <a href="https://github.com/deepsehgal/llmexpect">llmexpect</a>. Tier 1 = deterministic rules, Tier 2 = local embeddings, Tier 3 = LLM judge (your own model and key).</p>
</div>
<script>
