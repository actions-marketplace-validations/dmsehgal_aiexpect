...
<p class="foot">Generated by <a href="https://github.com/deepsehgal/aiexpect">aiexpect</a>. Tier 1 = deterministic rules, Tier 2 = local embeddings, Tier 3 = LLM judge (your own model and key).</p>
</div>
<script>
